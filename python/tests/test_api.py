...
class TestDict(unittest.TestCase):
    ...
    def test_query(self):
        # token = login(self.config['username'], self.config['password'])
        query_result = query_with_token_retry('GXBOX-${PREFIX}0036', '78cf8dfc533e48369cc3c0a1bcdfb6ee')
        self.assertTrue(isinstance(query_result, list))
        query_result = query_with_token_retry('GXBOX-${PREFIX}0036', '78cf8dfc533e48369cc3c0a1bcdfb6ee', 0)
