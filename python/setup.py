...
setup(
    ...
    entry_points={
        "console_scripts": [
			...
			"segway_s1=src.log.cli:segway_s1",
			"segway_robots=src.log.cli:segway_robots",
			...
			"segway_query2_ore=src.log.cli:segway_query2_ore",
			"segway_query_ore=src.log.cli:segway_query_ore",
			...
			"segway_ore=src.log.cli:segway_ore",
